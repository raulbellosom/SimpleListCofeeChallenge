...
function App() {
  ...
  return (
    <main className="h-full w-full bg-black grid grid-cols-1 grid-rows-1">
      ...
      />
      <div className="row-start-1 col-start-1 pt-40 pb-32 mx-36 h-full flex justify-center items-center ">
        <div className="w-full bg-gray-dark px-10 py-28 rounded-3xl">
          <div className="relative mx-20">
            <img
              src={Vector}
              alt="Vector"
              width={300}
              className="mx-auto absolute -top-20 left-1/2 transform -translate-x-3.5"
            />
            <div className="relative flex flex-col gap-5 justify-center">
              ...
              <div className="flex justify-center">
                <p className="text-gray-light w-[28rem] font-semibold text-center">
            ...
            <div className="pt-10 mt-12 w-full flex flex-wrap justify-center gap-5">
